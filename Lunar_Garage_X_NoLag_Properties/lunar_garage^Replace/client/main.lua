...
function SpawnVehicle(args)
    ...
    if not index or not props then
        print("Error: Prop Index Error")
        return
    end
    ...
    local vehicle = CreateVehicle(props.model, playerCoords.x, playerCoords.y, playerCoords.z, playerHeading, true, false)
    ...
    -- Apply properties to the vehicle
    lib.setVehicleProperties(vehicle, props)

    -- Set the vehicle position again in case of any issues
    ...
    -- Additional vehicle setup
    local plate = props.plate
    SetVehicleNumberPlateText(vehicle, plate)
    SetEntityAsMissionEntity(vehicle, true, true)
    SetVehicleHasBeenOwnedByPlayer(vehicle, true)
    TriggerServerEvent('lunar_garage:registerVehicle', vehicle, plate)

    -- Notify player
    lib.notify({title = 'Vehicle Spawned', description = 'Your vehicle has been spawned.', type = 'success'})
end



RegisterNetEvent('lunar_garage:spawnVehicleEvent')
AddEventHandler('lunar_garage:spawnVehicleEvent', SpawnVehicle)
...
RegisterNetEvent('lunar_garage:GetVehicleLabelEvent')
AddEventHandler('lunar_garage:GetVehicleLabelEvent', GetVehicleLabel)
...
RegisterNetEvent('lunar_garage:getClassIconEvent')
AddEventHandler('lunar_garage:getClassIconEvent', getClassIcon)
...
RegisterNetEvent('lunar_garage:getFuelBarColorEvent')
AddEventHandler('lunar_garage:getFuelBarColorEvent', getFuelBarColor)
...
RegisterNetEvent('lunar_garage:openGarageVehiclesEvent')
AddEventHandler('lunar_garage:openGarageVehiclesEvent', openGarageVehicles)
...
RegisterNetEvent('lunar_garage:saveVehicleEvent')
AddEventHandler('lunar_garage:saveVehicleEvent', saveVehicle)
...
local function retrieveVehicle(args)
    ...
    RegisterNetEvent('lunar_garage:retrieveVehicleEvent')
    AddEventHandler('lunar_garage:retrieveVehicleEvent', retrieveVehicle)
...
RegisterNetEvent('lunar_garage:openImpoundVehiclesEvent')
AddEventHandler('lunar_garage:openImpoundVehiclesEvent', openImpoundVehicles)
...
RegisterNetEvent('lunar_garage:openImpoundEvent')
AddEventHandler('lunar_garage:openImpoundEvent', openImpound)
